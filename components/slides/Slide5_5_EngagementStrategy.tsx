            ...
            <div className="flex flex-col items-center justify-center h-full gap-12">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8 w-full max-w-6xl">
                    ...
                    <motion.div
                        ...
                        className="p-8 rounded-3xl bg-zinc-900 border border-zinc-800 flex flex-col items-center text-center relative overflow-hidden group hover:border-blue-500/50 transition-colors"
                    >
                        ...
                        <h3 className="text-2xl font-bold text-white mb-2">Build Only</h3>
                        <p className="text-zinc-400 mb-6 flex-grow">Traditional software development. You need a custom website or app built from scratch.</p>
                    ...
                    <motion.div
                        ...
                        className="p-8 rounded-3xl bg-zinc-900 border border-zinc-800 flex flex-col items-center text-center relative overflow-hidden group hover:border-orange-500/50 transition-colors shadow-2xl shadow-orange-900/10 transform scale-105 z-10"
                    >
                        ...
                        <p className="text-zinc-400 mb-6 flex-grow">The sweet spot. Custom software powered by intelligent automation workflows.</p>
                    ...
                    <motion.div
                        ...
                        className="p-8 rounded-3xl bg-zinc-900 border border-zinc-800 flex flex-col items-center text-center relative overflow-hidden group hover:border-purple-500/50 transition-colors"
                    >
                        ...
                        <h3 className="text-2xl font-bold text-white mb-2">Automate Only</h3>
                        <p className="text-zinc-400 mb-6 flex-grow">You have existing processes. We optimize and automate them without new software.</p>
                        <div className="mt-auto px-4 py-2 rounded-full bg-zinc-800 text-sm font-mono text-zinc-300">
                            Process Heavy
                        </div>
                    </motion.div>
                ...
                >
                    ...
                    <span>Let's find the model that fits your needs</span>
